...
from bullet.tm700_rgbdsparse_Gym import  tm700_rgbdsparse_gym
...
results_plotter.plot_results([log_dir], time_steps, results_plotter.X_TIMESTEPS, "RGBD Observation with a Sparse Reward Function")
plt.show()
